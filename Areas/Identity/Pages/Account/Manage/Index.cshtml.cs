...
namespace Project.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(IdentityUser user)
        {
            ...
            var getFullUsername = await _userReponsitory.getUserByIdAsync(User.GetUserId());
            ...
            LastName = getFullUsername.LastName;
            FirstName = getFullUsername.FirtsName;

            City = getFullUsername.city;
            District = getFullUsername.district;
            Ward = getFullUsername.ward;
